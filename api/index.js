        ...
        <body>
          ...
          <div class="section">
            ...
            <div class="contract-details">
              ...
              <div class="detail-row">
                <div class="detail-label">��писание:</div>
          ...
          <div class="section">
            ...
            <p>4.2. Оплата производится в следующем поря��ке:</p>
            <ul>
    ...
    if (url === "/api/groq-chat" && method === "POST") {
      ...
      if (
        ...
        if (
          ...
          intelligentResponse =
            "🧠 Хороший вопрос! Анализируя ваш запрос, постараюсь д��ть развернутый ответ. Если это касается наших технологий или услуг - с радость�� расскажу подробности. Уточните, пожалуйста, что именно вас интересует?";
        } else if (
          lastMessage.includes("когда") ||
