...
async function testBookings() {
  ...
  const getAllReq = createMockReq('GET', '/api/bookings/all', {}, { 'user-id': 'admin' });
  ...
  const createReq = createMockReq('POST', '/api/bookings', {
    serviceType: 'pro',
  ...
  const getUserReq = createMockReq('GET', '/api/bookings', {}, { 'user-id': 'test-user' });
